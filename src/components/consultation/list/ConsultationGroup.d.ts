...
export declare function ConsultationGroup({ title, consultations, onJoin, onCancel, onReschedule }: ConsultationGroupProps): import("react/jsx-runtime").JSX.Element;
export {};
